...
<footer class="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
				...
				<span class="self-center text-2xl font-semibold">Mimi Salon</span>
			</a>
		</div>
		<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div class="space-y-3">
				<h3 class="tracki uppercase dark:text-gray-50">About Us</h3>
				<ul class="space-y-1">
					<li>
			...
			<div class="space-y-3">
				<h3 class="tracki uppercase dark:text-gray-50">Mimi Salon</h3>
				<ul class="space-y-1">
					<li>
	...
	<div class="py-6 text-sm text-center dark:text-gray-400">© 2023 Design by Mahlet</div>
</footer>
</body>
</html>